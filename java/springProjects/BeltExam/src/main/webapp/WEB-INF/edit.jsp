		...
		<form:form action="/courses/${course.id}" method="post" modelAttribute="course">
		    ...
		    <p>
		        ...
		        <form:select path="time" >
					...
					<form:option value="12:00 AM">12:00 PM</form:option>
					<form:option value="12:30 AM">12:30 PM</form:option>
					...
					<form:option value="12:00 PM">12:00 AM</form:option>
					<form:option value="12:30 PM">12:30 AM</form:option>
